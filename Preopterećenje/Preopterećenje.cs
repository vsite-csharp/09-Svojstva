namespace Vsite.CSharp.Svojstva
{
    ...
    class Preopterećenje
    {
        ...
        // public void VoidSvojstvo { get; set; } property or indexer cannot have void type
        
        // :021 Dodati novo svojstvo PreopterećenoSvojstvo koje će biti tipa int i pokušati prevesti kod.
       
        // public int PreopterećenoSvojstvo { get; set; } Preopterećenje already contains a definition for PreopterećenoSvojstvo
        static void Main()
        {
        }
    }
