    ...
    class Definicija
    {
        public class Osoba
        {
            ...
            public string Ime { 
                ...
                set {
                    if (value == null)
                        throw new ArgumentNullException(nameof(value), $"vrijednost{nameof(Ime)} ne smije bit nul referenca");
        ...
        static void Main(string[] args)
        {
            ...
            // T Pokrenuti program i provjeriti ispis za OsobuSPromjenivimPrezimenom.
