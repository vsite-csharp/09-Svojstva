    ...
    class Definicija
    {
        public class Osoba
        {
            ...
            public string Ime { 
                ...
                set {
                    ...
                    if (value == string.Empty)
                        throw new ArgumentException( $"vrijednost {nameof(Ime)} ne smije biti prazan stirng! ", nameof(value));
                    ime = value;
                }
            }
            ...
            public DateTime DatumRođenja
            {
                ...
                set
                {
                    datumRođenja = value.Date > DateTime.Now.Date ? throw new ArgumentOutOfRangeException(nameof(value), 
                        $"{nameof(datumRođenja)} mora biti manji od današnjeg datuma!") : value;
                }
            }
