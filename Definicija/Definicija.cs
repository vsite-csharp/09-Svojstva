...
namespace Vsite.CSharp.Svojstva
{
    class Definicija
    {
        public class Osoba
        {
            ...
            public string Ime
            {
                get => ime; // kada pozovem get metodu, onda vrati ime
                set
                {
                    if (value == null)
            ...
            //nije private jer ga ne prosljeduejmo konstruktoru
            ...
            public DateTime DatumRođenja
            {
                ...
                set
                {
                    if (value > DateTime.Now)
                        throw new ArgumentOutOfRangeException(nameof(DatumRođenja));
                    datumRođenja = value;
                }
            }
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Invalid dateTime: dateTime larger than current date.");
            }
