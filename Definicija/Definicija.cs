...
namespace Vsite.CSharp.Svojstva
{
    class Definicija
    {
        public class Osoba
        {
            ...
            // standardni način definiranja svojstva
            // private string prezime { get { return prezime; } set { prezime = value; } }
            public string Prezime { get; protected set; } // može "suziti" pravo pristupa (atributi su samo sužavajući)
            ...
            public string Ime { 
                ...
                {
                    if (value == null)
                        throw new ArgumentNullException(nameof(value)/*nameof pretvara u string*/, $"Vrijednost {nameof(Ime)} ne smije biti null referenca");
            ...
            public DateTime DatumRođenja
            {
                ...
                set {
                  ...
                  throw new ArgumentOutOfRangeException(nameof(value), $"{nameof(DatumRođenja)} mora biti manji od današnjeg datuma") 
                  : value;
                }
            }
