...
private string prezime;
            ...
            // TODO:001 Javno dostupno polje Ime nadomjestiti svojstvom            (property) koje se izvan klase može čitati i zadavati, ali priliko        zadavanja treba onemogućiti
...
private string ime;
            ...
            public string Ime
            {
                ...
                if (value == null)
                        throw new
                        ArgumentNullException($"{nameof(value)}must not be null reference");
                    if (value.Length == 0)
            ...
            // TODO:002 Javno dostupno polje DatumRođenja nadomjestiti  svojstvom(property) koje se izvan klase može čitati i zadavati, ali za           slučaj zadavanja           // datuma većeg od trenutnog treba baciti iznimku tipa           ArgumentOutOfRangeException.U pozivajućem kodu staviti odogovarajući kod           za hvatanje           // iznimke koji će u slučaju iznimke ispisati odgovarajuću           poruku.
            ...
            public DateTime DatumRođenja
            {
                ...
                set
                {
                    if (value.Date > DateTime.Now.Date)
                        throw new
                        ArgumentOutOfRangeException($"{nameof(value)} must not be...");
                    datumRođenja = value;
                }
            }
    ...
    public class OsobaSPromjenivimPrezimenom : Osoba
        {
            ...
            public OsobaSPromjenivimPrezimenom(string ime, string
            prezime) : base(ime, prezime)
            { }
...
Console.WriteLine("*** Osoba ***");
        ...
        // TODO:007 Pokrenuti testove (5 testova u grupi"TestDefinicijeSvojstva" mora proći).
            ...
            OsobaSPromjenivimPrezimenom o2 = new
            OsobaSPromjenivimPrezimenom("Nives", "Celzius");
