    ...
    class Definicija
    {
        public class Osoba
        {
            ...
            public DateTime DatumRođenja
            {
                ...
                set
                {
                    datumRođenja = value.Date > DateTime.Now.Date ? throw new ArgumentOutOfRangeException(nameof(value), $"{nameof(DatumRođenja)}" +
                  $" mora biti manji od današnjeg datuma.") : value;
                }
