...
namespace Vsite.CSharp.Svojstva
{
    class Definicija
    {
        public class Osoba
        {
            ...
            get=> datumRođenja;
            set {datumRođenja= value.Date > DateTime.Now.Date? throw new ArgumentOutOfRangeException(nameof(value), $"{nameof(DatumRođenja)} mora biti manji od današnjeg datuma") : value;}
            }
