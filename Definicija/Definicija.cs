    ...
    class Definicija
    {
        public class Osoba
        {
            ...
            public string Ime 
            {
                ...
                set 
                {
                    if (value == null) throw new ArgumentNullException(nameof(value),$"Vrijednost {nameof(Ime)} ne smije biti null referenca!");
                    if (value == string.Empty) throw new ArgumentException( $"Vrijednost {nameof(Ime)} ne smije biti prazan string!",nameof(value));
                    ime = value;
                }
            ...
            public DateTime DatumRođenja 
            {
                ...
                set
                {
                    datumRođenja = value.Date > DateTime.Now ?
