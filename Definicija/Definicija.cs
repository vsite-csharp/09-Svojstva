    ...
    class Definicija
    {
        public class Osoba
        {
            ...
            public string Ime { get { return ime; }
                ...
                {
                    if (value == null)
                        throw new ArgumentNullException(nameof(value), $"vrijednost {nameof(Ime)} nessmije biti null referenca");
                    if (value == string.Empty)
                        throw new ArgumentException($"vrijednost {nameof(Ime)} nessmije biti null referenca", nameof(value));
                    ime = value;
                }
            }
