...
namespace Vsite.CSharp.Svojstva
{
    class Definicija
    {
        public class Osoba
        {
            ...
            private string ime; 
            //Moramo imati član u pozadini
            public string Ime
            {
                get => ime; // kad pozove get metodu , onda vrati podatak iz lokalne klase gore
                set
                {
                    if (value == null)
                    {
        ...
        static void Main(string[] args)
        {
            ...
            o1.Ime = "Pero";
            //o1.Prezime = "Kvrgić"; svojstvo sa lijeve strane pridruživanja, pokušava se pozvati set metoda
            Console.WriteLine($"{o1.Ime} {o1.Prezime}");
