    ...
    class Definicija
    {
        public class Osoba
        {
            ...
            public string Ime
            {
                ...
                {
                    if (value == null)
                        throw new ArgumentNullException(nameof(value),$"Vrijednost {nameof(Ime)} nesmije biti nul referenca");
                    if (value == string.Empty)
                        throw new ArgumentException($"Vrijednost {nameof(Ime)} nesmije biti prazan string", nameof(value));
                    ime = value;
                }
            }
            ...
            {
                get => datumRođenja;
                set {  datumRođenja = value.Date > DateTime.Now.Date ?
