...
namespace Vsite.CSharp.Svojstva
{
    class ReferentniTipovi
    {
        public class Smočnica
        {
            ...
            //    get {return new List<string>(namirnice);} //dobiva kopiju, ne mijenja klasu smocnica, no nije elegantno
            //}

            public IEnumerable<string> Namirnice => namirnice; //IEnumerable sakriva implementaciju
